...
Gui Add, DropDownList, x210 ym+215 w150 vmanagerCode, ;% salesCodes
	for index, managerCode in managerCodes
	{
		GuiControl, , managerCode, %managerCode%
	}
...
;     Gui Submit, NoHide
;     GuiControl, ChooseString, SalesDirectorChoice, Denise Schwartz
;     GuiControl, ChooseString, DirectorCodeChoice, 201020
;     Gui Submit, NoHide
; return

SetDropDown(managerCode, salesDirectorChoice, directorCode)
{
	; if (salesManager = "")
	; {
    ;     ; Reset the values if there is no manager
    ;     ; GuiControl,, managerCode, 
	; 	GuiControl, Text, managerCode
    ;     GuiControl, Text, salesDirectorChoice, 
    ;     GuiControl, Text, DirectorCodeChoice, 
	; }
	; else 
	; {
        GuiControl, ChooseString, managerCode, %managerCode%
        GuiControl, ChooseString, salesDirectorChoice, %salesDirectorChoice%
        GuiControl, ChooseString, DirectorCodeChoice, %directorCode%
    ; }
    Gui Submit, NoHide
}

kellerDropDown:
	SetDropDown(202375, "Denise Schwartz", 201020)
return

mccormackDropDown:	
    SetDropDown(1261, "Maroun El Khoury", 1076)
return

hewittDropDown:	
    SetDropDown(98866, "Maroun El Khoury", 1076)
return

mcfaddenDropDown:	
    SetDropDown(202610, "N/A", "N/A")
return

butlerDropDown:	
    SetDropDown(1026, "Denise Schwartz", 201020)
return

kleinDropDown:	
    SetDropDown(1042, "Maroun El Khoury", 1076)
return

bennettDropDown:
    SetDropDown(1416, "Maroun El Khoury", 1076)
return

rogersDropDown:
    SetDropDown(203915, "Denise Schwartz", 201020)
return

nadjieDropDown:
    SetDropDown(96695, "Denise Schwartz", 201020)
return

tollstrupDropDown:
    SetDropDown(200320, "Sylveer Bergs", 203185)
return

craftsDropDown:
    SetDropDown(202625, "Denise Schwartz", 201020)
return
...
if salesManager =
	{
		; GuiControl, ChooseString, salesManager, ""
		GuiControl, Choose, managerCode, 23
		Gui Submit, NoHide
		; GuiControl, Choose, SalesDirectorChoice, |1
